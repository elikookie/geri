    ...
    <main>
      <div className="grid grid-cols-4 gap-4">
        <div class="col-span-1 p-10">
          <img className="m-5 w-64" src="logo.png"></img>
        </div>
        <div class="col-span-3">
          <div className="flex flex-col bg-slate-100 px-20 pt-20 pb-5">
            <p className="merriweather-bold text-lg text-center p-10">
            ...
            <p className="merriweather-regular text-md text-center">
              Have a look at my instagram accounts for more of my art:
            </p>

            <div className="flex flex-row justify-evenly">
              <a className="flex items-center" href="https://www.instagram.com/geri.0821/">
              ...
              <a className="flex items-center" href="https://www.instagram.com/geri.archive/">
                <img className="m-5 w-16" src="instagram.png"></img>
                <div>
                  <p>@geri.archive</p>
